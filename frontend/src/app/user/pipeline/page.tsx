...
import { LEAD_STAGES, type Lead, type Pipeline } from "@/types/api";
  ...
  return (
    <UserLayout>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-black">My Pipeline</h1>
          <p className="text-sm text-gray-500 mt-1">
            Kanban view of your leads by stage
          </p>
        </div>
          ...
          <div className="flex gap-4 overflow-x-auto pb-2">
            {stages.map((stage) => {
              ...
              return (
                <div
                  key={stage}
                  className="min-w-[260px] flex-shrink-0 bg-white rounded-xl border border-gray-100 shadow-sm"
                >
